    ...
    <div class="row mb-20-none">
        <div class="col-xl-6 col-lg-6 mb-20">
            <div class="custom-card mt-10">
                ...
                <div class="card-body profile-body-wrapper">
                    <form class="card-form" method="POST" action="{{ setRoute('driver.profile.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="profile-settings-wrapper">
                            ...
                            <div class="profile-thumb-content">
                                <div class="preview-thumb profile-thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview bg_img" data-background="{{ auth('driver_gurd')->user()->userImage }}"></div>
                                    </div>
                                ...
                                <div class="profile-content">
                                    <h6 class="username">{{ auth('driver_gurd')->user()->username }}</h6>
                                    <ul class="user-info-list mt-md-2">
                                        <li><i class="las la-envelope"></i>{{ auth('driver_gurd')->user()->email }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 form-group">
                                    @include('admin.components.form.input',[
                                        ...
                                        'value'         => old('firstname',auth('driver_gurd')->user()->firstname)
                                    ])
                                </div>
                                <div class="col-xl-6 col-lg-6 form-group">
                                    @include('admin.components.form.input',[
                                        ...
                                        'value'         => old('lastname',auth('driver_gurd')->user()->lastname)
                                    ])
                                </div>
                                <div class="col-xl-6 col-lg-6 form-group">
                                    <label>{{ __("Country") }}<span>*</span></label>
                                    <select name="country" class="form--control select2-auto-tokenize country-select" data-placeholder="Select Country" data-old="{{ old('country',auth('driver_gurd')->user()->address->country ?? "") }}"></select>
                                </div>
                                <div class="col-xl-6 col-lg-6 form-group">
                                    <label>{{ __("Phone") }}<span>*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-text phone-code">+{{ auth('driver_gurd')->user()->mobile_code }}</div>
                                        <input class="phone-code" type="hidden" name="phone_code" value="{{ auth('driver_gurd')->user()->mobile_code }}" />
                                        <input type="text" class="form--control" placeholder="Enter Phone ..." name="phone" value="{{ old('phone',auth('driver_gurd')->user()->mobile) }}">
                                    </div>
                                    @error("phone")
                                ...
                                <div class="col-xl-6 col-lg-6 form-group">
                                    @php
                                        $old_state = old('state',auth('driver_gurd')->user()->address->state ?? "");
                                    @endphp
                                ...
                                <div class="col-xl-6 col-lg-6 form-group">
                                    @php
                                        $old_city = old('city',auth('driver_gurd')->user()->address->city ?? "");
                                    @endphp
                                    <label>{{ __("City") }}</label>
                                ...
                                <div class="col-xl-6 col-lg-6 form-group">
                                    @include('admin.components.form.input',[
                                        ...
                                        'value'         => old('zip_code',auth('driver_gurd')->user()->address->zip ?? "")
                                    ])
                                </div>
                                <div class="col-xl-6 col-lg-6 form-group">
                                    @include('admin.components.form.input',[
                                        ...
                                        'value'         => old('address',auth('driver_gurd')->user()->address->address ?? "")
                                    ])
                                </div>
                            </div>
        ...
        <div class="col-xl-6 col-lg-6 mb-20">
            <div class="custom-card mt-10">
                ...
                <div class="card-body">
                    <form class="card-form" action="{{ setRoute('driver.profile.password.update') }}" method="POST">
                        @csrf
                        @method("PUT")
...
@push('script')
    ...
    $(".del-account-btn").click(function(){
        var actionRoute = "{{ setRoute('driver.profile.destroy.account') }}";
        var target      = 1;
