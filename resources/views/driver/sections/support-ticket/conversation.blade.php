        ...
        <div class="support-card-wrapper">
            <div class="card-header">
                <div class="card-header-user-area">
                    <img class="avatar" src="{{ get_image($support_ticket->driver->image,'driver-profile') }}" alt="client">
                    <div class="card-header-user-content">
                        <h6 class="title">{{ $support_ticket->driver->fullname }}</h6>
                ...
                <div class="chat-container messages">
                    <ul>
                        @foreach ($support_ticket->conversations ?? [] as $item)
                            <li class="media media-chat @if ($item->sender_type == 'DRIVER') media-chat-reverse sent @else replies @endif">
...
@include('admin.components.support-ticket.conversation.connection-driver',[
    'support_ticket' => $support_ticket,
    'route'          => setRoute('driver.support.ticket.messaage.send'),
])