        ...
        <div class="account-area">
           <div class="account-thumb">
                ...
                <div class="account-form-area">
                    ...
                    <form action="{{ setRoute('driver.register.submit') }}" class="account-form" method="POST">
                        @csrf
                        <div class="row ml-b-20">
                            ...
                            <div class="col-lg-12 text-center">
                                <div class="account-item mt-10">
                                    <label>{{ __("Already Have An Account?") }} <a href="{{ setRoute('driver.login') }}" class="text--base">{{ _("Login Now") }}</a></label>
                                </div>
                            </div>
                        </div>
                    </form>
