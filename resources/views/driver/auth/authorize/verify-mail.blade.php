            ...
            <div class="account-header text-center">
                ...
                <div class="account-form-area">
                    <div>
                        ...
                        <p class="d-block ">{{ __("We sent a 6 digit code here ") }} <b> {{ $email }}</b></p>
                    </div>
                    <form action="{{ setRoute('driver.authorize.mail.verify',$token) }}" class="account-form" method="POST">
                        @csrf
                         <div class="row">
                    <div class="col-lg-12 form-group otp-form">
                        ...
                        <input class="otp" type="text"  name="code[]"  oninput='digitValidate(this)' onkeyup='tabChange(2)' maxlength=1 required>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="account-item">
                            <label>{{__("Back To")}} <a href="{{ setRoute('driver.login') }}" class="account-control-btn">{{__("Login")}}</a></label>
                        </div>
                    </div>
                    <div class="col-lg-12 text-center">
...
@push('script')
    ...
    var resendCodeLink = "{{ route('driver.authorize.mail.resend', $token) }}";
