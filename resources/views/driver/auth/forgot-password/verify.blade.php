     ...
     <div class="account-area">
            <div class="account-header text-center">
                ...
                <div class="account-form-area">
                    ...
                    <p>{{ __("We sent a 6 digit code here") }} <strong>{{ $driver_email ?? ""}}</strong></p>
                    <form action="{{ setRoute('driver.password.forgot.verify.code',$token) }}" class="account-form" method="POST">
                        @csrf
...
@push('script')
    ...
    var resendCodeLink = "{{ route('driver.password.forgot.resend.code', $token) }}";
