                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            @include('admin.components.form.input',[
                                                ...
                                                'value'         => old($item->code . "_address",$data->value->language->$lang_code->address ?? "")
                                            ])
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                           @include('admin.components.form.input',[
                                                ...
                                                'name'          => $item->code . "_schedule",
                                                'value'         => old($item->code . "_schedule",$data->value->language->$lang_code->schedule ?? "")
                                            ])
                                        </div>
                                    </div>
                                @endforeach
