...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#how-work-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><span class="text--dark">{{ textLength($item->language->$system_default_lang->description ?? "") }}</span></td>
                                 <td>
    ...
    @include('admin.components.modals.site-section.add-how-to-page-item')

    <!-- {{-- About Page edit modal --}} -->
    <div id="how-page-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("how-work-item-add","#how-work-item-add");
        openModalWhenError("how-page-item-edit","#how-page-item-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#how-page-item-edit");
            ...
            openModalBySelector("#how-page-item-edit");
