...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#statisticts-page-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
                            ...
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>
                                    @include('admin.components.form.switcher',[
                                        ...
                                        'onload'      => true,
                                        'data_target' =>  $item->id,
                                        'permission'  => "admin.setup.section.status.update",
                                    ])
                                </td>
                                <td>
    ...
    @include('admin.components.modals.site-section.add-statistics-page-item')

    {{-- About Page edit modal --}}
    <div id="statisticts-page-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("statisticts-page-item-add","#statisticts-page-item-add");
        openModalWhenError("statisticts-page-item-edit","#statisticts-page-item-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#statisticts-page-item-edit");
            ...
            openModalBySelector("#statisticts-page-item-edit");
        ...
        $(document).ready(function(){
            switcherAjax("{{ setRoute('admin.setup.sections.section.status.update',$slug) }}");
        })
    </script>
@endpush