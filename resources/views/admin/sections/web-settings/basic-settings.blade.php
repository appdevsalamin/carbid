...
@section('content')
    ...
    <div class="custom-card mt-15">
     ...
     <div class="custom-card mt-15">
        <div class="card-header">
            <h6 class="title">{{ __("Activation Settings (Driver)") }}</h6>
        </div>
        <div class="card-body">
            <div class="custom-inner-card mt-10 mb-10">
                <div class="card-inner-body">
                    <div class="row mb-10-none">
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __('Driver Registration'),
                                'name'          => 'driver_registration',
                                'value'         => old('driver_registration',$basic_settings->driver_registration),
                                'options'       => ['Activated' => 1,'Deactivated' => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __('Driver Secure Password'),
                                'name'          => 'driver_secure_password',
                                'value'         => old('driver_secure_password',$basic_settings->driver_secure_password),
                                'options'       => ['Activated' => 1,'Deactivated' => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __('Driver Agree Policy'),
                                'name'          => 'driver_agree_policy',
                                'value'         => old('driver_agree_policy',$basic_settings->driver_agree_policy),
                                'options'       => ['Activated' => 1,'Deactivated' => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __('Driver Email Verification'),
                                'name'          => 'driver_email_verification',
                                'value'         => old('driver_email_verification',$basic_settings->driver_email_verification),
                                'options'       => ['Activated' => 1,'Deactivated' => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __('Driver Email Notification'),
                                'name'          => 'driver_email_notification',
                                'value'         => old('driver_email_notification',$basic_settings->driver_email_notification),
                                'options'       => ['Activated' => 1,'Deactivated' => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __('Driver Push Notification'),
                                'name'          => 'driver_push_notification',
                                'value'         => old('driver_push_notification',$basic_settings->driver_push_notification),
                                'options'       => ['Activated' => 1,'Deactivated' => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __('Driver KYC Verification'),
                                'name'          => 'driver_kyc_verification',
                                'value'         => old('driver_kyc_verification',$basic_settings->driver_kyc_verification),
                                'options'       => ['Activated' => 1,'Deactivated' => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
