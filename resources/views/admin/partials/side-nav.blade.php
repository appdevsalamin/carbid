                            ...
                            [
                             ...
                             [
                                ...
                                'links'     => [
                                    ...
                                    [
                                        'title'     => "Email Unverified",
                                        'route'     => "admin.drivers.email.unverified",
                                    ],
                                    [
                                        'title'     => "KYC Unverified",
                                        'route'     => "admin.drivers.kyc.unverified",
                                    ],
                                    [
                                        'title'     => "All Drivers",
                                    ...
                                    [
                                        'title'     => "Email To Drivers",
                                        'route'     => "admin.drivers.email.drivers",
                                    ],
                                    [
                                        'title'     => "Banned Drivers",
                                        'route'     => "admin.drivers.banned",
                                    ]
                                ],
                            ],
                            [
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown @if (in_array($current_url,$setup_section_childs)) active @endif">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                ...
                                <a href="{{ setRoute('admin.setup.sections.section','whychoose') }}" class="nav-link @if ($current_url == setRoute('admin.setup.sections.section','whychoose')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __("Why Choose Section") }}</span>
                                 </a>
