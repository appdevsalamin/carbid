@if (admin_permission_by_name("admin.drivers.send.mail"))
    <div id="email-send" class="mfp-hide large">
        <div class="modal-data">
            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.drivers.send.mail',$driver->username) }}" enctype="multipart/form-data">
                    @csrf
