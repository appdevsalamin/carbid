    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            if (Schema::hasTable('basic_settings')) {
                ...
                if ($basic_settings && $basic_settings->admin_prefix) {
                    $adminPrefix = $basic_settings->admin_prefix;
                }
            }
            ...
            Route::middleware(['web','auth','verification.guard','user.google.two.factor']) // user auth guard
            ...
            Route::middleware(['web','verification.guard','driver.google.two.factor']) //driver auth gurd
